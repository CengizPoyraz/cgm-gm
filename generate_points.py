...
=======
data = pd.read_csv('$GMS_HOME/data/training_data_E_filtered_stations.csv', header=None)
>>>>>>> b0d5aeb400b03719e433f6a069ecf6687eab5b83
...
=======
log_path = '$GMS_HOME/log/GM_V2_VAE_data5_dist-5000_bs=128-rnn_size=32-z_dim=32-lr=0.0008-weight:kl=0.2-log_reg=True-w_decay=1e-05-w_len=160-h_len=46-ncond=16-tcondvar=2-seed=3407'
>>>>>>> b0d5aeb400b03719e433f6a069ecf6687eab5b83
...
=======
non_ergs = pd.read_csv(f'$GMS_HOME/data/Non_Ergodic_Prediction_Matrix_Map_2Hz.csv', header=None) # load the non-ergodic GMM file
>>>>>>> b0d5aeb400b03719e433f6a069ecf6687eab5b83
...
=======
    np.save(f'$GMS_HOME/data/Gen_FAS_cond2.npy', Amplitude_Signal_Smoothed_loop_pred)
>>>>>>> b0d5aeb400b03719e433f6a069ecf6687eab5b83
    exit()
